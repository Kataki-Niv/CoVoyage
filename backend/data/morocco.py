...
def get_morocco_seed_dataset():
    return build_compact_destination(
        ...
        source_record=MOROCCO_SOURCE, image_url="https://images.unsplash.com/photo-1597212618440-806262de4f6b?auto=format&fit=crop&w=1800&q=85",
        places=[
            place("marrakech", "morocco", "Marrakech", "Marrakech-Safi", "Medina and garden city", "Marrakech centers on souks, gardens, palaces, riads, food stalls, hammams, and intense old-city energy.", ["Souks", "Gardens", "Riads", "Palaces", "Food"], ["markets", "culture", "food", "architecture", "city"], ["Markets", "Food", "Gardens", "Hammam"], MOROCCO_SOURCE, "https://images.unsplash.com/photo-1597212618440-806262de4f6b?auto=format&fit=crop&w=900&q=84"),
